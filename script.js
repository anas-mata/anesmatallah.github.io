...
const translations = {
  ...
  ar: {
    ...
    about_title: "من أنا",
    about_text: "أنا أنس معطالله، طالب سنة أولى علوم حاسوب بالجامعة. شغوف بالبرمجة، حل المشكلات، واستخدام التكنولوجيا لأتمتة المهام وتحليل البيانات. هدفي هو أن أصبح مطوراً ماهراً من خلال استمرار تعلم لغات وإطارات عمل جديدة، وبناء مشاريع عملية تحدث فرقاً.",
